  ...
  return (
    ...
    <nav className="fixed w-full bg-black text-[#F2F2F2] px-5 py-2.5 flex items-center justify-between font-[Poppins]">
      <h2 className="text-2xl md:text-3xl font-bold text-[#1DCD9F] cursor-pointer transition-colors duration-300 hover:text-[#FF0B55]">
        <Link to ="hero" smooth={true} offset={-50} duration={700}>MY PORTFOLIO</Link>
      </h2>
      <ul className="hidden md:flex gap-6 text-white text-lg">
       <li className="hover:text-[#1DCD9F] cursor-pointer"><Link to ="tools" smooth={true} offset={-10} duration={700}>Tools</Link></li>
        <li className="hover:text-[#1DCD9F] cursor-pointer"><Link to ="background" smooth={true} offset={-50} duration={700}>Background</Link></li>
